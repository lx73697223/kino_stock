...
from strategy import scanning_momentum_strategy
...
if __name__ == '__main__':
    ...
    scheduler.add_job(func=scanning_momentum_strategy.run, trigger=CronTrigger.from_crontab(""), name='strategy.scanning_momentum')
    scheduler.start()
